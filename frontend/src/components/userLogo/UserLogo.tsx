...
const Online = () => {
  return (
    <div className="circle online" style={{ backgroundColor: "green" }}></div>
  );
};

const Offline = () => {
  return (
    <div className="circle offline" style={{ backgroundColor: "brown" }}></div>
  );
};
...
const UserLogo = ({ showStatus = true }: Props) => {
  ...
  const statusComp =
    status === CurrentStatus.ONLINE ? <Online /> : <Offline />; /*TODO*/
  return (
